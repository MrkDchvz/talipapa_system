...
public class AddOrderForm extends javax.swing.JFrame {
    ...
    private AdminOrderTablePanel adminOrderTablePanelScreen;
    
    
    /**
     * Creates new form addOrderForm
     */
    public AddOrderForm(AdminOrderTablePanel adminOrderTablePanelScreen ) {
...
//             Insert the order to the database
                ...
                if (rowsAffected == 1) {
                    ...
                    cmbProductId.setSelectedIndex(0);
                    // Refresh Order Table
                    getAdminOrderTablePanelScreen().populateTable();
...
//        });
    ...
    /**
     * @return the adminOrderTablePanelScreen
     */
    public AdminOrderTablePanel getAdminOrderTablePanelScreen() {
        return adminOrderTablePanelScreen;
    }
}
